...
class TreeSortRunner:
   ...
   def prepare_input_file(self) -> bool:
      ...
      try:
         ...
         # TODO: This might be a good place to validate the input FASTA file. The FASTA header
         # requires the segment name/abbreviation surrounded by |'s and a date at the end.
